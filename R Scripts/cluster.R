...
#Read in data
college.data <- read.table("C:/Users/local_dedwards7/Desktop/R Files/CollUniv.txt",sep=",",header=TRUE)
...
cars <- read.table("C:/Users/local_dedwards7/Desktop/R Files/cars_mod.txt",sep=",",header=TRUE)
