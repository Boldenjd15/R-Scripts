...
example <- read.table("C:/Users/local_dedwards7/Desktop/R files/CorrespondenceAnalysis.txt",header=TRUE,sep=',')
...
crime <- read.table("C:/Users/local_dedwards7/Desktop/R files/CityCrimeData.txt",header=TRUE,sep=',')
...
diy <- read.table("C:/Users/local_dedwards7/Desktop/R files/DoItYourself.txt",header=TRUE,sep=',')
